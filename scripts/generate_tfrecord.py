...
Source:
***************************************************************************************
  *    Title: generate_tfrecord.py
  *    Author: user of GitHub with nickname "datitran" -> https://github.com/datitran
  *    Date: 21.8.2018
  *    Code version: 1
  *    Availability: https://github.com/datitran/raccoon_dataset/blob/master/generate_tfrecord.py
**************************************************************************************
'''
