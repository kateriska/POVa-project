...
# german dataset for test trained model because traffic signs are quite simmilar to Czech Republic and we dont have any huge Czech traffic signs dataset :DD
...
german_test_dataset_path_png = "/home/katerina/Documents/POVa-project/data/predict"
